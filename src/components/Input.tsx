...
function Input(
  ...
  const inputClassName = twMerge(
    className,
    "rounded-lg border  bg-white p-2 text-sm font-normal text-primaryDark shadow-sm placeholder-primaryDark placeholder-opacity-20 outline-none transition-all",
